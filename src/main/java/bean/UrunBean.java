...
public class UrunBean implements Serializable {
    ...
    public void setTumUrunler(List<Urun> tumUrunler) {
    ...
    public Long getSeciliVitrinKategoriId() {
        return seciliVitrinKategoriId;
    }

    public void setSeciliVitrinKategoriId(Long seciliVitrinKategoriId) {
        this.seciliVitrinKategoriId = seciliVitrinKategoriId;
    }

    public Long getDetayUrunId() {
        return detayUrunId;
    }

    public void setDetayUrunId(Long detayUrunId) {
        this.detayUrunId = detayUrunId;
    }

    public Urun getDetayUrun() {
        return detayUrun;
    }

    public void setDetayUrun(Urun detayUrun) {
        this.detayUrun = detayUrun;
    }

    public Part getYuklenenGorsel() {
        return yuklenenGorsel;
    }

    public void setYuklenenGorsel(Part yuklenenGorsel) {
        this.yuklenenGorsel = yuklenenGorsel;
    }
